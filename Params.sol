...
contract Params {
   ...
   // uint64 public constant WithdrawProfitPeriod = 28800;
    uint256 public  MinimalStakingCoin = 50 ether;
    // minimum initial staking to become a validator
    uint256 public  minimumValidatorStaking = 100000 ether;
    ...
    uint public  burnPartPercent = 25000;                //25%
    uint public  contractPartPercent = 0;        //0%
    uint public  burnStopAmount = 1000000 ether;      // after 1000,000 coins burn, it will stop burning
